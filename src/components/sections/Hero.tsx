...
export function Hero() {
  ...
  return (
    <section id="inicio" className="relative min-h-[90vh] flex items-center pt-24 pb-16 overflow-hidden bg-background">
      ...
      <div className="absolute top-0 right-[-10%] w-[800px] h-[800px] bg-primary/10 rounded-full blur-[150px] -z-10 animate-pulse-soft" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[600px] h-[600px] bg-accent/15 rounded-full blur-[120px] -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 grid lg:grid-cols-2 gap-12 items-center relative z-10 w-full">
        <div className="space-y-8 animate-fade-up">
          ...
          <div className="flex flex-wrap gap-5 pt-4">
            <Button size="lg" className="rounded-full shadow-xl shadow-primary/20 h-16 px-10 group bg-primary hover:bg-primary/90 text-white border-none text-lg font-bold transition-all hover:scale-105" asChild>
              <Link href="#recursos">
                Explorar Ayuda
          ...
          <div className="flex items-center gap-4 pt-6 text-muted-foreground/60 animate-fade-in [animation-delay:400ms]">
            <p className="text-sm font-semibold italic flex items-center gap-3">
